...
DURATION_LIMIT_MIN = int(gethai env("DURATION_LIMIT", 600))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/mooncodessssss/moon",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+VJ2ZfK3jc0FlZDcx")
